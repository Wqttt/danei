<template>
  <div>
    <!-- Home.vue -->
    <!-- 1.顶部导航条-->
    <titlebar leftTitle="微信(11)" :rightFirstImg="require('../../assets/ic_search.png')" :rightSecondImg="require('../../assets/ic_add.png')" :search="mysearch" :add3="myadd3"></titlebar>
    <!-- 2.保留元素 -->
    <!-- 3.面板组件 -->
...
//1.1引入消息列表子组件
import MessageList from "../message/common/MessageList.vue"
//1.2引入底部导航条图片切换组件
...
export default {
  data(){
    return {
      ...
      //集中保存所有按钮状态
      currentIndex:[
        {isSelect:true},//0 保存第1个按钮状态
        {isSelect:false},//1 保存第2个按钮状态
        {isSelect:false},//2 保存第3个按钮状态
        {isSelect:false}//3 保存第4个按钮状态
      ]
    }
  },
  // 2.注册TitleBar.vue
